...
| bpf.intraNodeVisibility | object | `{"enabled":false}` | Enable intra-node visibility for direct routing mode. This is an experimental feature. |
| bpf.intraNodeVisibility.enabled | bool | `false` | Enable intra-node visibility. |
